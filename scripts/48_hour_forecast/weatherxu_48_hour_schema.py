...
cursor.execute("DROP SCHEMA IF EXISTS weatherxu_48 CASCADE;")
cursor.execute("CREATE SCHEMA weatherxu_48;")
print("Schema 'weatherxu_48' dropped and recreated.")

# Create the dim_city table
create_dim_city_table = """
CREATE TABLE weatherxu_48.dim_city (
    city_id SERIAL PRIMARY KEY,
    city_name VARCHAR(100) NOT NULL
);
"""
cursor.execute(create_dim_city_table)
print("Table 'weatherxu_48.dim_city' created.")

# Create the dim_date table
create_dim_date_table = """
CREATE TABLE weatherxu_48.dim_date (
...
print("Table 'weatherxu_48.dim_date' created.")

# Create the condition_dim table
create_dim_condition_table = """
CREATE TABLE weatherxu_48.dim_condition (
    condition_id SERIAL PRIMARY KEY,
    condition_name VARCHAR(50) NOT NULL
);
"""
cursor.execute(create_dim_condition_table)
print("Table 'weatherxu_48.dim_condition' created.")

# Create the weather_fact table
create_fact_weather_table = """
CREATE TABLE weatherxu_48.fact_weather (
...
print("Table 'weatherxu_48.fact_weather' created.")
